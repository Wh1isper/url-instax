...
git remote add origin git@github.com:wh1isper/url-instax.git
...
- Add the API Token to your projects secrets with the name `PYPI_TOKEN` by visiting [this page](https://github.com/wh1isper/url-instax/settings/secrets/actions/new).
- Create a [new release](https://github.com/wh1isper/url-instax/releases/new) on Github.
